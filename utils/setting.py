...
"""Parent Size"""
PARENT_SIZE_WIDTH = "parent size width"
PARENT_SIZE_HEIGHT = "parent size height"
...
"""Text"""
if _executor == "training.py" and _executor == "eval.py":
	DEFAULT_FONT_SIZE = 0
else:
	DEFAULT_FONT_SIZE = 2 * SCREEN_SCALE

DEFAULT_FONT_TYPE = "comicsansms"
# DEFAULT_FONT_TYPE = None
...
DEFAULT_THICK = (2 * SCREEN_SCALE, 2* SCREEN_SCALE)
...
GAME_INTRO_LISTENING_EVENT = [pygame.QUIT, ON_TICK]
...
LEVEL = {PLAYER1_HIGH_SCORE :
			...
			LEVEL_1 : {"level": 1,
					   "score": 500,
					   "setting": {"snake": {"speed": 40 * SCREEN_SCALE, "thick" : DEFAULT_THICK},
								   "item": {"apple": {"num" : 2, "probability": 80,"lifeTimer": CONTINUANCE}}
								   }
					   },
			LEVEL_2 : {"level": 2,
					   "score": 1500,
					   "setting": {"snake": {"speed": 60 * SCREEN_SCALE, "thick" : DEFAULT_THICK},
								   "item": {"apple": {"num" : 2, "probability": 30,"lifeTimer": CONTINUANCE}}
								   }
					   },
			LEVEL_3 : {"level": 3,
					   "score": 3000,
					   "setting": {"snake": {"speed": 70 * SCREEN_SCALE, "thick" : DEFAULT_THICK},
								   "item": {"apple": {"num" : 3, "probability": 10,"lifeTimer": 4 * FRAMES_PER_SECOND}}
								   }
					   },
			LEVEL_4 : {"level": 4,
					   "score": 4500,
					   "setting": {"snake": {"speed": 80 * SCREEN_SCALE, "thick" : DEFAULT_THICK},
								   "item": {"apple": {"num" : 4, "probability": 5,"lifeTimer": 2 * FRAMES_PER_SECOND}}
								   }
					   },
			LEVEL_5 : {"level": 5,
					   "score": 6000,
					   "setting": {"snake": {"speed": 90 * SCREEN_SCALE, "thick" : DEFAULT_THICK},
								   "item": {"apple": {"num" : 3, "probability": 3,"lifeTimer": 1 * FRAMES_PER_SECOND}}
								   }
					   },
			LEVEL_6 : {"level": 6,
					   "score": 7500,
					   "setting": {"snake": {"speed": 100 * SCREEN_SCALE, "thick" : DEFAULT_THICK},
								   "item": {"apple": {"num" : 6, "probability": 10,"lifeTimer": 0.1 * FRAMES_PER_SECOND}}
								   }
					   },
			LEVEL_7 :  {"level": 7,
						"score": 10000,
						"setting": {"snake": {"speed": 110 * SCREEN_SCALE, "thick" : DEFAULT_THICK},
									"item": {"apple": {"num" : 4, "probability": 0.5,"lifeTimer": 0.5 * FRAMES_PER_SECOND}}
									}
						},
			LEVEL_8 :  {"level": 8,
						"score": 12000,
						"setting": {"snake": {"speed": 115 * SCREEN_SCALE, "thick" : DEFAULT_THICK},
